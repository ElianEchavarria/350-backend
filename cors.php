...
function setupCORS() {
    ...
    if (PHP_VERSION_ID >= 70300) {
        $secure = isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] === 'https' || isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on';
        session_set_cookie_params([
            'lifetime' => 0,
            'path' => '/',
            'domain' => '',
            'secure' => $secure,  // Use proxy header to detect HTTPS
            'httponly' => true,
